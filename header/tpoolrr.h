...
enum tpoolrr_thread_strategy {
    TPOOLRR_THREAD_STRATEGY_ROUNDROBIN,
    TPOOLRR_THREAD_STRATEGY_HASHED
};
...
enum tpoolrr_thread_backend {
    TPOOLRR_THREAD_BACKEND_NOTHREAD,
    TPOOLRR_THREAD_BACKEND_ONETHREAD,
    TPOOLRR_THREAD_BACKEND_MANYTHREADS,
    TPOOLRR_THREAD_BACKEND_ONEGREENTHREAD,
    TPOOLRR_THREAD_BACKEND_MANYGREENTHREADS
};
...
//Tpoolrr *tpoolrr_create(size_t thread_count, size_t jobs_per_consumer,
    //enum TPOOL_STRATEGY strategy,
    //enum TPOOL_CONCURRANCY concurrancy
//);
...
int tpoolrr_jobs_add(Tpoolrr *pool, uint64_t user_tag, void *((*function)(Tpoolrr*,void*)), void *arg, size_t expiration);
...
int tpoolrr_jobs_addall(Tpoolrr *pool, size_t count, uint64_t user_tag[], void *((*functions[])(Tpoolrr*,void*)), void *args[], size_t expiration);
